...
Automobile fatalities are a leading cause of death worldwide, posing a public health and safety concern for urban cities. For example, in 2024, thirty people have died on Toronto's roadways so far, which is a 20% increase from last year [@cbc_2024]. However, news headlines, such as CBC's, highlight that Motor Vehicle Collisions (MVC) tend to either be generalized as a summary statistic or typically fatal events are over analyzed to the extent that environmental elements surrounding the crash are ignored. General environmental elements such as the time of the crash or if a bicycle was involved in the accident are important to understand what increases the likelihood of a fatality occurring in an MVC. The use of statistical modeling on increasingly available vehicle collision data presents an opportunity to develop a nuanced understanding of what variables increases the likelihood for a fatality to occur in an accident. This paper uses the Toronto Police Service's  Annual Statistical Report from Open Data Toronto to analyze what determinants are most responsible in predicting if a fatality occurs in a MVC.
...
#| fig-cap: Distribution of Fatalities Variable in the Cleaned Dataset    
#| echo: false
#| message: false
#| warning: false
#| fig-width: 5
...
#| warning: false
#| label: tbl-hour
#| tbl-cap: Number of MVCs for Each Hour  
#| tbl-align: center
#| tbl-width: 82%
...
```{r}
#| label: fig-hour
#| fig-cap: Graphical Representation of Number of Fatalities for Each Hour 
#| echo: false
#| message: false
#| warning: false
#| fig-width: 5
...
### Collision Type (Injury, Fail to Remain, and Property Damage Collisions) {#sec-data-predictor-crash}
...
```{r}
#| label: fig-crashtype
#| fig-cap: Breakdown of Distribution of Each Collision Type  
#| echo: false
#| message: false
#| warning: false
#| fig-width: 5
...
#| warning: false
#| label: tbl-crashtype
#| tbl-cap: Breakdown of MVCs Into the Different Crash Type Categories by Fatalities
#| tbl-align: center
#| tbl-width: 82%
...
#| fig-cap: Graphical Representation of the Automobile Variable's Values 
#| echo: false
#| message: false
#| warning: false
#| fig-width: 5
...
#| tbl-cap: Breakdown of Automobile Variable Based on Fatalities Occured
#| tbl-align: center
#| tbl-width: 82%
...
#| fig-cap: Graphical Representation of the Motorcycle Variable's Values
#| echo: false
#| message: false
#| warning: false
#| fig-width: 5
...
# Plot distribution of Motorcycle Variable
...
#| tbl-cap: Summary of the Motorcycle Variable Based on Fatality Occurrence  
#| tbl-align: center
#| tbl-width: 82%
...
```{r}
#| label: fig-passenger
#| fig-cap: Graphical Representation of the Passenger Variable's Values
#| echo: false
#| message: false
#| warning: false
#| fig-width: 5
...
# Plot distribution of Passenger Variable
...
#| warning: false
#| label: tbl-passenger
#| tbl-cap: Summary of the Passenger Variable Based on Fatality Occurrence 
#| tbl-align: center
#| tbl-width: 82%


# Calculate summary statistics for the 'passenger' variable
summary_stats <- analysis_data %>%
  group_by(passenger) %>%
  summarize(
    "No Fatalities" = sum(fatalities == 0, na.rm = TRUE),
...
#| tbl-cap: Summary of the Pedestrian Variable Based on Fatality Occurrence
#| tbl-align: center
#| tbl-width: 82%


# Calculate summary statistics for the 'pedestrian' variable
summary_stats <- analysis_data %>%
  group_by(pedestrian) %>%
  summarize(
    "No Fatalities" = sum(fatalities == 0, na.rm = TRUE),
...
#| fig-cap: Graphical Representation of the Pedestrian Variable's Values
#| echo: false
#| message: false
#| warning: false
#| fig-width: 5
...
# Plot distribution of Pedestrian Variable
...
# Plot distribution of Police Division Variable
...
#| warning: false
#| label: tbl-division
#| tbl-cap: Summary of the Police Division Variable by Fatality Occurrence
#| tbl-align: center
#| tbl-width: 82%
...
#| fig-cap: Graphical Representation of Fatalities by Hour for Motorcyclists
#| echo: false
#| message: false
#| warning: false
#| fig-width: 5
...
#| tbl-cap: Graphical Representation of Fatalities by Hour for Pedestrians
#| tbl-align: center
#| tbl-width: 82%
...
To enhance the model, Bayesian priors were applied, introducing regularization and incorporating plausible ranges grounded. For the coefficient priors $\beta$, a normal distribution with a mean of 0 and a scale of 2.5 (autoscaled) was chosen to provide flexibility while mitigating over-fitting. Similarly, the intercept uses a normal prior with a mean of 0 and a scale of 2.5 to stabilize model estimates. For the error term (sigma), an exponential prior with a rate of 1 was selected to constrain the residuals, aligning with Gaussian assumptions.
