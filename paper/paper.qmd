...
+ \beta_{5} x_{\text{automobile}_{i}} 
+ \beta_{6} x_{\text{motorcycle}_{i}} 
+ \beta_{7} x_{\text{passenger}_{i}} 
+ \beta_{8} x_{\text{pedestrian}_{i}} 
+ \beta_{9} x_{\text{PoliceDivision}_{i}} 
+ \beta_{10} x_{\text{year}_{im}} 
+ \beta_{11} x_{\text{hour}_{i}} \cdot x_{\text{motorcycle}_{i}} 
